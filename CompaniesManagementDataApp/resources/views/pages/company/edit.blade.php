          ...
          <form runat="server" method="post" action="{{ route('company.update', $company) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Edit Company Data') }}</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="{{ __('Email') }}" value="{{ old('email', $company->email) }}" required />
                      @if ($errors->has('email'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('alamat') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('alamat') ? ' is-invalid' : '' }}" name="alamat" id="input-alamat" type="alamat" placeholder="{{ __('Alamat') }}" value="{{ old('alamat', $company->alamat) }}" required />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('website') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('website') ? ' is-invalid' : '' }}" name="website" id="input-website" type="text" placeholder="{{ __('Website') }}" value="{{ old('website', $company->website) }}" required />
